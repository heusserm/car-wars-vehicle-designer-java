...
public class Weapon {
    ...
    public static final List<Weapon> DROPPED = Arrays.asList(
            ...
            new Weapon("Flame Cloud Ejector", "FCE", "-", "1d-1", 2, 500, 50, 2, 10, 60, 5),
            new Weapon("HD Flame Cloud Ejector", "HDFCE", "-", "1d-1", 2, 1000, 100, 3, 10, 240, 20),
            ...
            new Weapon("Flaming Oil Jet", "FOJ", "-", "1d-2", 3, 300, 30, 2, 25, 35, 2),
            new Weapon("Heavy Flaming Oil Jet", "HFOJ", "-", "1d-2", 4, 550, 60, 3, 10, 140, 8),
